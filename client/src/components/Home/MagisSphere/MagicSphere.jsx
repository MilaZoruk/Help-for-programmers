  ...
  return (
    <div className={styles.sphere}>
      ...
      <div className={styles.input}>
        <form onSubmit={onClickHandler} className="mx-auto w-full">
          <div className="flex flex-col md:flex-row items-center mb-3">
            <div className="relative mr-3 w-full">
              ...
              <button type="submit"
              className="text-white right-2.5 mt-4 md:mt-0 bottom-2.5 bg-gray-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Получить предсказание</button>
          </div>
        </form>
      </div>
    </div>
