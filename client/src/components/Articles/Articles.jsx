...
const callouts = [
  ...
  },
  {
    ...
    imageSrc:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVhcORLiRV7Ol4V10lZ0IRrlgq6Rw3D1lDMyF2SpqFxho_3eTBaRc0hKqgWnORoPEipeQ&usqp=CAU',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc:
      'https://sowa-ru.com/wp-content/uploads/2019/02/piyadehr.piyadehr8.png',
  ...
  },
  {
    ...
    imageSrc:
      'https://img.freepik.com/free-vector/work-in-garden-set_74855-1485.jpg?w=2000',
    imageAlt: 'Collection of four insulated travel bottles on wooden shelf.',
    href: '/article',
  },
  {
    ...
    <div className="bg-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
          <h2 className="text-2xl font-bold text-gray-900">Какое-то общее название, надо придумать</h2>
